...
WaitDlg::WaitDlg(QWidget *parent) :
    QWidget(parent), angle(0),displayMode(IMAGE)
{
...
{
	painter->fillRect(0, 0, this->width(), this->height(), QBrush(QColor(255,255,255,150)));
...
{
	painter->fillRect(0, 0, this->width(), this->height(), QBrush(QColor(255,255,255,200)));
